...
<div id="contenidoEstudiante" ng-controller="estudianteCtrl">
    ...
    <div class="">
		...
		<center><h4>Educación General Superior</h4></center>
		
		<div class="col-lg-6">
			<label>Seleccione el año lectivo:</label>
			<form ng-submit="mostrarEstudiantes()">
				<input type="hidden" id="nivelEstudiantes" value="Educacion General Superior">
				<div class="form-inline">
					<select class="form-control" style="margin-right: 5px;" 
					name="aniosL" id="aniosL" ng-model="aniosL" required>
						<option value="">Seleccionar</option>
						<option ng-repeat="a in aniosLectivos" 
						value="{{a.anioinicio_pera}}-{{a.aniofin_pera}}/{{a.mesinicio_pera}} {{a.anioinicio_pera}} - {{a.mesfin_pera}} {{a.aniofin_pera}}">
